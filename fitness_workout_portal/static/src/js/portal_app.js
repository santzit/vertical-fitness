...
registry
  ...
  .add("fitness_workout_portal.WorkoutDashboard", WorkoutDashboard);
registry
  .category("public_components")
  .add("fitness_workout_portal.WorkoutRoutinesList", WorkoutRoutinesList);
registry
  .category("public_components")
  .add("fitness_workout_portal.WorkoutRoutineDetail", WorkoutRoutineDetail);
registry
  .category("public_components")
  .add("fitness_workout_portal.WorkoutExerciseDetail", WorkoutExerciseDetail);
